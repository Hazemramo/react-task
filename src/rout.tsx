...
const Rout = ({ product, setproduct, details, view, clickedProducts, close, setclose, cartdetails, setcartdetails, Addtocart, deletecart }) => {
    return (
        <>
            <Routes>
                ...
                <Route path='/cart' element={<Cart cartdetails={cartdetails} setcartdetails={setcartdetails} setclose={setclose} close={close} deletecart={deletecart} />} />
            </Routes>
        </>
    )
}
